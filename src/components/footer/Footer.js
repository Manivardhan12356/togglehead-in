...
const Footer = () => {
   return (
      <section className='Footer'>
         <div className="container footer-main d-flex justify-content-between">
            <div className='d-flex flex-column footer-main'>
               <h3>Contact us</h3>
            ...
            <div className='icons'>
               ...
               <div className="icon d-flex">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fff" class="bi bi-instagram" viewBox="0 0 16 16">
                     ...
                     <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-quora" viewBox="0 0 16 16">
            ...
            <div className='head-office'>
               <h3>Head Office</h3>
               <p>Lorem ipsum dolor sit amet, consetetur sadipscing <br /> elitr, sed diam nonumy eirmod tempor invidunt ut
</p>
         ...
         <div className='copyright'>
            <p className='text-center'>©  2021 All Rights Reserved. Privacy Policy</p>
         </div>
      </section>
   )
}
